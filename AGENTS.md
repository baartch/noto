...
## Recent Changes
- 001-build-profile-memory-cli: Added Go 1.23+ + Cobra (CLI command surface), Bubble Tea + Bubbles + Lip Gloss (TUI),

- 001-build-profile-memory-cli: Added Go 1.23+ + Cobra (CLI commands), Bubble Tea + Bubbles + Lip Gloss (TUI),
