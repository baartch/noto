...
- **FR-012**: Keybinding hints MUST only appear in help views (footer help or list help); list headers and editors must not duplicate keybinding hints. The help view MUST show only keybindings relevant to the current view (settings, profiles list, editor, picker).
