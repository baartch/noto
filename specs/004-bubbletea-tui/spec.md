...
7. **Given** the TUI is active, **When** help is expanded, **Then** it appears above the input textarea.
8. **Given** the TUI is active, **When** the footer is rendered, **Then** it displays keybinding help.
...
- **FR-009**: The system MUST render keybinding help in the footer using the Bubbles Help component.
- **FR-010**: The system MUST render expanded help above the input textarea when help is opened.
...
- **SC-007**: The footer consistently shows keybinding help for the active view.
- **SC-008**: Expanded help renders above the input textarea when opened.
