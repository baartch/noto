...
- Validate vector index corruption/missing-file handling warns and falls back until rebuild.
...
4. Delete or tamper with vector index file and verify warning + fallback.
